...
echo "C:\Program Files\PowerShell\6\pwsh.exe" -Command "(get-content \"%%~n1%%~x1\" -encoding OEM) -replace '(usepackage{.*)hfont', '$1kotex' | Out-File -encoding UTF8NoBOM \"%%~n1_kotex%%~x1\"" > hfont_to_kotex.bat
