...
if %OS%==32BIT echo "C:\Program Files\MikTex 2.9\scripts\tex4ht\htlatex.bat" "%%~n1" > LaTeX_to_html.bat
if %OS%==64BIT echo "C:\Program Files (x86)\MikTex 2.9\scripts\tex4ht\htlatex.bat" "%%~n1" > LaTeX_to_html.bat
